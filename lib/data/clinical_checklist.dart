...
class ClinicalChecklist {
  ...
  static const List<String> levels = ['Level I', 'Level II', 'Level III'];
  ...
  static const List<ChecklistItem> _levelOne = [
    ...
    // Restorative Dentistry Simulated Cases — Typodont (42)
    // Class 1 (6 unfilled + 6 filled)
    ChecklistItem(
      key: 'l1_resto_sim_class1_unfilled_1',
      title: 'Class 1 Typodont (Unfilled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_unfilled_2',
      title: 'Class 1 Typodont (Unfilled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_unfilled_3',
      title: 'Class 1 Typodont (Unfilled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_unfilled_4',
      title: 'Class 1 Typodont (Unfilled) #4',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_unfilled_5',
      title: 'Class 1 Typodont (Unfilled) #5',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_unfilled_6',
      title: 'Class 1 Typodont (Unfilled) #6',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_filled_1',
      title: 'Class 1 Typodont (Filled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_filled_2',
      title: 'Class 1 Typodont (Filled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_filled_3',
      title: 'Class 1 Typodont (Filled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_filled_4',
      title: 'Class 1 Typodont (Filled) #4',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_filled_5',
      title: 'Class 1 Typodont (Filled) #5',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class1_filled_6',
      title: 'Class 1 Typodont (Filled) #6',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 1 · Filled',
    ),
    ...
    ChecklistItem(
      ...
      title: 'Class 2 Typodont (Unfilled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_unfilled_2',
      title: 'Class 2 Typodont (Unfilled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_unfilled_3',
      title: 'Class 2 Typodont (Unfilled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_unfilled_4',
      title: 'Class 2 Typodont (Unfilled) #4',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_unfilled_5',
      title: 'Class 2 Typodont (Unfilled) #5',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_unfilled_6',
      title: 'Class 2 Typodont (Unfilled) #6',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_filled_1',
      title: 'Class 2 Typodont (Filled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_filled_2',
      title: 'Class 2 Typodont (Filled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_filled_3',
      title: 'Class 2 Typodont (Filled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_filled_4',
      title: 'Class 2 Typodont (Filled) #4',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_filled_5',
      title: 'Class 2 Typodont (Filled) #5',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class2_filled_6',
      title: 'Class 2 Typodont (Filled) #6',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 2 · Filled',
    ),
    ...
    ChecklistItem(
      ...
      title: 'Class 3 Typodont (Unfilled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 3 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class3_unfilled_2',
      title: 'Class 3 Typodont (Unfilled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 3 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class3_unfilled_3',
      title: 'Class 3 Typodont (Unfilled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 3 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class3_filled_1',
      title: 'Class 3 Typodont (Filled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 3 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class3_filled_2',
      title: 'Class 3 Typodont (Filled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 3 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class3_filled_3',
      title: 'Class 3 Typodont (Filled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 3 · Filled',
    ),
    ...
    ChecklistItem(
      ...
      title: 'Class 4 Typodont (Unfilled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 4 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class4_unfilled_2',
      title: 'Class 4 Typodont (Unfilled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 4 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class4_unfilled_3',
      title: 'Class 4 Typodont (Unfilled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 4 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class4_filled_1',
      title: 'Class 4 Typodont (Filled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 4 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class4_filled_2',
      title: 'Class 4 Typodont (Filled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 4 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class4_filled_3',
      title: 'Class 4 Typodont (Filled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 4 · Filled',
    ),
    ...
    ChecklistItem(
      ...
      title: 'Class 5 Typodont (Unfilled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 5 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class5_unfilled_2',
      title: 'Class 5 Typodont (Unfilled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 5 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class5_unfilled_3',
      title: 'Class 5 Typodont (Unfilled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 5 · Unfilled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class5_filled_1',
      title: 'Class 5 Typodont (Filled) #1',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 5 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class5_filled_2',
      title: 'Class 5 Typodont (Filled) #2',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 5 · Filled',
    ),
    ChecklistItem(
      key: 'l1_resto_sim_class5_filled_3',
      title: 'Class 5 Typodont (Filled) #3',
      section: 'Restorative Dentistry Simulated Cases',
      subtitle: 'Typodont · Class 5 · Filled',
    ),
  ...
  static const List<ChecklistItem> _levelTwo = [
    ...
    ChecklistItem(
      ...
      title:
          'Fixed Restoration — Antero-Posterior FPD (Mx canine & 2nd premolar)',
      section: 'Prosthodontics Simulated Cases',
